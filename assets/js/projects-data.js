...
window.MEDORA_PROJECTS = [
  {
    ...
    summary:
      "A Kerala-inspired villa study shaped by tiled roofs, generous verandahs and a welcoming arrival court.",
    description:
  ...
  {
    id: "classic-two-storey-villa",
    title: "Classic Two-Storey Villa",
    location: "Kerala",
    style: "Contemporary",
    categories: ["Contemporary", "Villas"],
    summary:
      "A composed two-storey home balancing pitched forms, stone accents and a shaded family frontage.",
    description:
  ...
  {
    id: "completed-family-residence",
    title: "Completed Family Residence",
    location: "Kerala",
    style: "Traditional",
    categories: ["Traditional", "Villas", "Completed"],
    summary:
      "A completed residence with broad verandahs, patterned paving and a calm, well-finished approach.",
    description:
  ...
  {
    id: "pitched-roof-residence",
    title: "Pitched Roof Residence",
    location: "Kerala",
    style: "Traditional",
    categories: ["Traditional", "Completed"],
    summary:
      "A completed home with layered roof forms, a sheltered porch and a compact family-friendly plan.",
    description:
  ...
  {
    id: "stone-fence-residence",
    title: "Stone Fence Residence",
    location: "Kerala",
    style: "Contemporary",
    categories: ["Contemporary", "Completed"],
    summary:
      "A completed residence with a defined compound wall, shaded frontage and practical family planning.",
    description:
  ...
  {
    id: "interior-courtyard-detail",
    title: "Interior Courtyard Detail",
    location: "Kerala",
    style: "Interior",
    categories: ["Interior", "Completed"],
    summary:
      "A refined interior court showing how lighting, greenery and material detail can soften a home.",
    description:
